...
class MemoryScreenKor extends StatefulWidget {
  @override
  _MemoryScreenKorState createState() => _MemoryScreenKorState();
}

class _MemoryScreenKorState extends State<MemoryScreenKor> {
